...
class Patient(Base):
    ...
    cgm_records: Mapped[list["CGMRecord"]] = relationship(back_populates="patient", cascade="all, delete-orphan")
    cgm_sessions: Mapped[list["CGMSession"]] = relationship(back_populates="patient", cascade="all, delete-orphan")
