...
from sqlalchemy import String, Integer, Float, Date, DateTime, ForeignKey, Text, Boolean, ARRAY
...
# Ensure forward references resolve for relationships across modules
import src.models.clinical  # noqa: E402, F401
