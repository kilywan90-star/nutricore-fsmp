...
# ============================================================
# 1. 模板知识库 (从340条长沙医院超声模板CSV提取, 7大类)
# ============================================================
TEMPLATE_TAGS = {
    "腹部": [
        "正常男性腹部全套(无门静脉)","正常女性腹部全套(无门静脉)",
        "肝胆胰脾双肾未见明显异常","脂肪肝","脂肪肝(轻)","脂肪肝(中)","脂肪肝(中-重)",
        "肝多发囊肿","肝囊肿","肝血管瘤","肝硬化","肝内钙化灶",
        "胆囊多发结石","胆囊充填型结石","胆囊结石(泥沙)","胆囊多发息肉(胆固醇)","胆囊息肉","胆囊炎(慢性)","胆囊壁毛糙",
        "胆总管结石","胆管扩张","肾多发结石","肾结石","肾囊肿","左肾囊肿","双肾囊肿","肾积水",
        "胰腺炎","脾大","腹水",
    ],
    "妇产": [
        "女性经阴道彩超子宫附件","子宫附件未见明显异常",
        "子宫肌瘤","子宫肌瘤伴囊性变","子宫多发肌瘤","子宫腺肌症",
        "子宫内膜息肉","子宫内膜回声不均","卵巢囊肿","卵巢畸胎瘤","附件囊肿",
        "早孕(宫内)","中孕(单活胎)","中孕(双胎)","晚孕(单活胎)",
        "宫内早孕(约6W+)","异位妊娠","盆腔积液","宫颈囊肿",
    ],
    "心脏": [
        "心脏结构未见明显异常","心脏彩超未见明显异常",
        "左心功能正常","左心功能减低","扩张型心肌病","肥厚型心肌病",
        "二尖瓣关闭不全","主动脉瓣关闭不全","三尖瓣关闭不全",
        "主动脉瓣狭窄","二尖瓣狭窄","心包积液","肺动脉高压",
        "室间隔缺损","房间隔缺损","冠心病","左房增大","心肌肥厚",
    ],
    "甲状腺乳腺": [
        "甲状腺(正常)","甲状腺双侧叶未见异常","甲状腺单发结节","甲状腺多发结节",
        "甲状腺囊实性结节","甲状腺弥漫性病变","桥本氏甲状腺炎",
        "甲状腺TI-RADS 3类","甲状腺TI-RADS 4a类",
        "乳腺未见异常","乳腺增生","乳腺结节单发","乳腺多发结节",
        "乳腺BI-RADS 2类","乳腺BI-RADS 3类","乳腺BI-RADS 4b类",
    ],
    "血管": [
        "双侧颈动脉内膜毛糙","双侧颈动脉未见明显异常",
        "颈动脉多发斑块形成","颈动脉狭窄","椎动脉狭窄","锁骨下动脉狭窄",
        "下肢动脉硬化","双下肢动脉硬化伴斑块","下肢深静脉血栓",
        "腹主动脉瘤","肾动脉狭窄",
    ],
    "泌尿前列腺": [
        "前列腺增生","前列腺多发钙化灶","前列腺钙化灶","前列腺稍大",
        "前列腺增生伴钙化","膀胱结石","膀胱残余尿","膀胱憩室",
        "睾丸及附睾未见异常","精索静脉曲张","附睾炎",
    ],
    "其他": [
        "TCD正常","TCD异常","膝关节积液","髋关节积液",
        "胸水定位","体表包块","腹股沟疝","阑尾炎","腮腺炎","浅表淋巴结",
    ],
}
